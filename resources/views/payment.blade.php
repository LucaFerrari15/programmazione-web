...
@section('contenuto_principale')
    ...
    <div class="row">
        <div class="col-md-5 offset-md-1 my-2 my-md-4">
            <div class="row">
                <form method="POST" action="{{ route('orders.checkout') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="nome" name="nome_spedizione" placeholder="nome"
                                    required />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="nome_carta" name="nome_carta" placeholder="Nome"
                                    required />
